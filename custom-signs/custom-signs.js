...
export function buildBirthdaySign(age) {
  const keyWord = age < 50 ? "young" : "mature";
  return `Happy Birthday! What a ${keyWord} fellow you are.`
}
...
export function costOf(sign, currency) {
  const costStr = (20 + 2 * sign.length).toFixed(2);
  return `Your sign costs ${costStr} ${currency}.`
}

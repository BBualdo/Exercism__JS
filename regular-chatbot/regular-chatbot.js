...
export function checkPhoneNumber(number) {
  ...
  const isNumberCorrect = regex.test(number);
  return isNumberCorrect ? "Thanks! You can now download me to your phone." : `Oops, it seems like I can't reach out to ${number}`;
}
